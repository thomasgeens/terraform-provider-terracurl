...
func TestCurlResource_StateUpgrade(t *testing.T) {
	...
	schemaVar := schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"request_body_file":       resourceRequestBodyFileSchema(""),
			"request_multipart":       resourceMultipartSchema(""),
			...
			"read_request_body_file":       resourceRequestBodyFileSchema(""),
			"read_request_multipart":       resourceMultipartSchema(""),
			...
			"destroy_request_body_file":       resourceRequestBodyFileSchema(""),
			"destroy_request_multipart":       resourceMultipartSchema(""),
